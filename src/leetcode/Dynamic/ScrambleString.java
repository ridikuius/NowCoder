...
public class ScrambleString {
    ...
    public boolean isScramble2(String s1, String s2) {
        ...
        for (int i = 1; i < s1.length(); i++) {
            ...
            if (isScramble2(s11, s24) && isScramble2(s12, s23)) {
                return true;// cut
            }
    ...
    private boolean isValid2(String s1, String s2) {
    ...
    //记忆化搜索
    private boolean checkScramble(String s1, int start1, String s2, int start2, int k,
                                  int[][][] visit) {
        ...
        for (int i = 1; i < s1.length(); i++) {
            ...
            if (checkScramble(s11, start1, s21, start2, i, visit) && checkScramble(s12, start1 + i,
                                                                                   s22, start2 + i,
                                                                                   k - i, visit)) {
                visit[start1][start2][k] = 1;
                return true;
